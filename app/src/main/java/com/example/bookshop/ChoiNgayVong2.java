...
public class ChoiNgayVong2 extends AppCompatActivity {
        ...
        if (id==123){
            ...
            quaylai_choingay.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    startActivity(new Intent(ChoiNgayVong2.this, ChoiNgayActivity.class));
                }
            });
        }else
        {
            ...
            if(TrangChuFragment.database.TonTaiBanBe(LoginActivity.taiKhoan.getMATK(),taiKhoan.getMATK())){
                ...
                themban_choingay.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Toast.makeText(ChoiNgayVong2.this, " Thêm thành công ", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(ChoiNgayVong2.this, BanBeActivity.class));
                    }
                });
            }else {
                ...
                themban_choingay.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Toast.makeText(ChoiNgayVong2.this, " Xóa thành công", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(ChoiNgayVong2.this,BanBeActivity.class));
                    }
                });
            }
    ...
    private void Btn_setEnabled() {
        ...
        img_nextvong.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(ChoiNgayVong2.this, "Bạn hãy hoàn thành hết hành trình nhé!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void Event() {
        ...
        btn_vong1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ChoiNgayVong2.this, TracnghiemActivity.class);
                intent.putExtra("vong",2.1F);
    ...
    private void checkvong(int id) {
        ...
        Listvong2.clear();
        Cursor cursor = TrangChuFragment.database.Getdata("SELECT VONG,SOSAO FROM VONGCHINH WHERE VONG >2 AND VONG <3 AND  IDTK  = " + id);
...
//            btn_vong5.setEnabled(true);
            ...
            img_nextvong.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    startActivity(new Intent(ChoiNgayVong2.this, Animation_Vong3.class));
                }
            });
        }catch (Exception e){
    ...
    private void AnhXa() {
        ...
        Framelayout_choingay.setBackgroundResource(R.drawable.bg_animation_hai);
